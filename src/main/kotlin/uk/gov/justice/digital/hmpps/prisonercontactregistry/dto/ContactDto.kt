...
class ContactDto(
  ...
  @Schema(description = "Code for relationship to Prisoner", example = "RO", required = true)
  ...
  @Schema(description = "Type of Contact", example = "O", required = true)
  val contactType: String,
  @Schema(description = "Description of Contact Type", example = "Official", required = false)
  val contactTypeDescription: String? = null,
  @Schema(description = "Approved Visitor Flag", required = true)
  val approvedVisitor: Boolean,
  @Schema(description = "Emergency Contact Flag", required = true)
  val emergencyContact: Boolean,
  @Schema(description = "Next of Kin Flag", required = true)
