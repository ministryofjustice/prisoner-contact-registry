...
class AddressUsageDto(
  @Schema(description = "The address usages", example = "HDC", required = false)
  val addressUsage: String? = null,
  @Schema(description = "The address usages description", example = "HDC Address", required = false)
  val addressUsageDescription: String? = null,
  @Schema(description = "Active Flag", example = "true", required = false)
